...
function ExecuteSearch( rgParameters )
{
	...
	g_ajaxInFlight = new Ajax.Updater( 'search_results', 'https://viga.me/search/results', { parameters: rgParameters, method: 'get', onComplete: SearchCompleted.bind( null, rgParameters ) } );
}
