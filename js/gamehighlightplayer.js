...
HighlightPlayer.prototype.RecordView = function( movieid )
{
	...
	{
		$J.get( 'https://viga.me/videoview/' + movieid + '/' );
	}
};
...
HighlightPlayer.prototype.ShowScreenshotPopup = function( screenshotid )
{
	...
	$Title.append( ' ', $J('<img/>', {src: 'https://static-cdn.viga.me/images/ico_external_link.gif' } ) );

	var $TitleCtn = $J('<div/>', {'class': 'screenshot_popup_modal_title'} ).append( $Title );

	var $Img = $J('<img/>', {'src': this.GetScreenshotURL( screenshotid, '600x338' ) } );
	var $ImgPreload = $J('<img/>', {'src': 'https://static-cdn.viga.me/images/blank.gif', 'style': 'display: none;' } );
