...
CDiscoveryQueue.prototype.BuildQueue = function( rgDiscoveryQueue )
{
	...
	this.m_$Queue.empty();
	this.m_iActiveItem = 0;
	this.m_$Overlay.attr( 'href', 'https://viga.me/explore/next/');
	...
	if ( !this.m_bStatic )
	{
		this.m_$ActiveLink = $J('<a/>').append( $J('<img/>', {'class': 'dq_item_cap', src: 'https://static-cdn.viga.me/images/header_placeholder_460x215.gif' } ) );
...
CDiscoveryQueue.ShowCustomizeDialog = function( fnOnSettingsChanged )
{
	...
	var strSettingsURL = 'https://viga.me/explore/discoveryqueuesettings/';
	...
	.done( function(data) {
		...
		Modal.done( function() {
			...
			$J.post( 'https://viga.me/explore/updatediscoveryqueuesettings',{
...
{
	var _this = this;
	$J.post( 'https://viga.me/explore/generatenewdiscoveryqueue', {
		sessionid: g_sessionID,
		queuetype: this.m_eQueueType,
	}).done( function ( data ) {
		window.location = 'https://viga.me/explore/next';
	}).fail( function() {
